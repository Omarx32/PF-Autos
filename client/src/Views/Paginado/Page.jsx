...
return (
  ...
  <button disabled={currentPage === 1} className={styles.paginationprevious} onClick={onPreviusPage}>
  ...
  <button disable={currentPage === pageNumbers.length}className={styles.paginationnext} onClick={onNextPage}>
  <svg
      width="20"
      height="27"
      viewBox="0 0 20 27"
